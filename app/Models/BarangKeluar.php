...
class BarangKeluar extends Model
{
        ...
        return [
            ...
            'customer' => [
                ...
                'errors' => [
                    ...
                    'max_length' => 'Customer maksimal 100 karakter'
                ]
            ],
            'nama_barang' => [
                'rules' => 'required|max_length[100]',
    ...
    /**
     * Filter barang keluar berdasarkan pencarian dan range tanggal
     */
    public function filterBarangKeluar($search = '', $tanggal_awal = '', $tanggal_akhir = '', $limit = null, $offset = null)
    {
        $builder = $this;
        if ($search) {
        ...
        if ($tanggal_awal && $tanggal_akhir) {
            $builder = $builder->where('tanggal_keluar >=', $tanggal_awal)
                               ->where('tanggal_keluar <=', $tanggal_akhir);
        } elseif ($tanggal_awal) {
            $builder = $builder->where('tanggal_keluar >=', $tanggal_awal);
        } elseif ($tanggal_akhir) {
            $builder = $builder->where('tanggal_keluar <=', $tanggal_akhir);
        }
        ...
        return $builder->orderBy('tanggal_keluar', 'ASC')->findAll();
    }
} 