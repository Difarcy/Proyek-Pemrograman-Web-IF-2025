...
<div class="modal fade" id="modal-tambah">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/barang-masuk/tambah') ?>" method="post">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" onclick="printInvoice('BM20240320001')">
...
<script>
    ...
    function printInvoice(noTransaksi) {
        window.open('<?= base_url('admin/barang-masuk/cetak/') ?>' + noTransaksi, '_blank');
    }
</script>
</body>
</html> 