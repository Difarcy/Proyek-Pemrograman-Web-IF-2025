...
<?= $this->section('content') ?>
    <div class="v-container-fluid">
        <h1 class="v-mb-4">Data Customer</h1>
        <div class="v-card v-mb-4">
            <div class="v-card-header v-bg-white v-d-flex v-justify-content-between v-align-items-center v-border-0">
                <h5 class="v-mb-0">Daftar Customer</h5>
                <button type="button" class="v-btn v-btn-primary v-btn-sm" data-toggle="modal" data-target="#modal-tambah">
                    <i class="fas fa-plus"></i> Tambah Customer
                </button>
            </div>
            <div class="v-card-body v-p-3">
                <div class="v-table-responsive">
                    <table class="v-table v-table-bordered v-table-striped v-mb-0">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama Customer</th>
