...
<?= $this->section('title') ?>ubah_password<?= $this->endSection() ?>
...
<div class="content-wrapper" id="contentWrapper" style="padding-bottom:0 !important;">
    <div class="container-fluid p-0" style="padding-bottom:0 !important;">
        <div class="card shadow-sm" style="margin-top:0;margin-left:0;margin-right:0;margin-bottom:0;min-height:calc(100vh - 56px);">
            <div class="card-body">
                <div class="d-flex flex-row align-items-stretch">
                    <div class="pl-4 d-flex flex-column align-items-center justify-content-start" style="min-width:160px;">
                        <div class="profile-pic-wrapper" tabindex="0" title="Profil Admin">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="font-weight-bold text-primary mb-4" style="letter-spacing:0.5px;">Ganti Password</h5>
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control input-balance" id="old_password" name="old_password" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control input-balance" id="new_password" name="new_password" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control input-balance" id="confirm_new_password" name="confirm_new_password" required>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="card-footer bg-white text-right" style="margin-bottom:0;">
                <button type="submit" class="btn btn-primary btn-modern">Simpan</button>
                <a href="<?= base_url('admin/profil') ?>" class="btn btn-danger btn-modern ml-2">Batal</a>
            </div>
        </div>
    </div>
</div>
